      ...
      <div class="flex">
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <textarea name="details" placeholder="nhập mô tả" class="box" required maxlength="500" cols="30" rows="10"></textarea>
         </div>
      </div>
      
      <input type="submit" value="Thêm mới" class="btn" name="add_product">
   </form>
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="price">VNĐ <span><?= $fetch_products['price']; ?></span></div>
      <div class="details"><span><?= $fetch_products['details']; ?></span></div>
      <div class="flex-btn">
         <a href="update_product.php?update=<?= $fetch_products['id']; ?>" class="option-btn">Cập nhật</a>
         <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Xoá sản phẩm này?');">Xoá</a>
      </div>
   </div>
   <?php
         }
      }else{
         echo '<p class="empty">Chưa sản phẩm nào được thêm!</p>';
      }
   ?>
