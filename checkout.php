...
<section class="checkout-orders">
   ...
   <h3>Đơn Hàng Của Bạn</h3>
      ...
      ?>
         <p> <?= $fetch_cart['name']; ?> <span>(<?= 'đ'.$fetch_cart['price'].' x '. $fetch_cart['quantity']; ?>)</span> </p>
      <?php
            }
         }else{
      ...
      ?>
         ...
         <div class="grand-total">Số tiền : <span>VND. <?= $grand_total; ?></span></div>
      </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="flat" placeholder="số nhà/căn hộ" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="city" placeholder="Tỉnh/Thành phố" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Huyện:</span>
            <input type="text" name="state" placeholder="Huyện/Quận" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Phường:</span>
            <input type="text" name="country" placeholder="Phường/Xã/Thị trấn" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Mã zipcode :</span>
            <input type="number" min="0" name="pin_code" placeholder=" ví dụ: 56400" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;" class="box" required>
         </div>
      </div>
